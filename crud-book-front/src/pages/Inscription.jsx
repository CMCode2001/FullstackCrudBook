...
export default function Inscription() {
  ...
  // Regex pour email et mot de passe fort
    ...
    <div className="inscription-container">
      ...
      <div className="inscription-right">
        <form className="inscription-form" onSubmit={handleInscription}>
          ...
          {/* <div style={{ color: "#555", fontSize: "0.95em", marginBottom: 8 }}>
            Le mot de passe doit contenir au moins 8 caractères, une majuscule, une minuscule, un chiffre et un caractère spécial.
          </div> */}
          {passwordError && <div style={{ color: "#e11d48", fontSize: "0.95em", marginBottom: 8 }}>{passwordError}</div>}
